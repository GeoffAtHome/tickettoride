...
export class WelcomePage extends PageViewElement {
  ...
  protected render() {
    return html`
      <h1>Ticket to Ride cards for the game v0.0.8</h1>
      <h3>Background</h3>
      <p>
      ...
      <h1>Releases</h1>
      <ul>
        <li>v0.0.8 - Report where station is being played.</li>
        ...
        <li>
          v0.0.4 - Fix issue like four cards to start with, shuffling discard
          pile when deck is empty. Display other players turn.
        </li>
        <li>v0.0.3 - Add trains and icons.</li>
