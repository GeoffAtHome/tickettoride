...
export const CHANGE_USER_GAME = 'CHANGE_USER_GAME';
...
export interface AppActionChangeUserGame extends Action<'CHANGE_USER_GAME'> {
  player: string;
  game: string;
}
...
export const updateUserGameState: ActionCreator<AppActionChangeUserGame> = (
  player: string,
  game: string
) => {
  return {
    type: CHANGE_USER_GAME,
    player,
    game,
  };
};
